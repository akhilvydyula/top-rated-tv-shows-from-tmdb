...
Open-source features enabled for **TMDB Top-Rated TV Shows Dashboard**.
...
| Tech stack | Python, Streamlit, scikit-learn, Plotly, MLflow |
...
| Discussions | [GitHub Discussions](https://github.com/akhilvydyula/top-rated-tv-shows-from-tmdb/discussions) |
...
3. Open or pick an [issue](https://github.com/akhilvydyula/top-rated-tv-shows-from-tmdb/issues)
