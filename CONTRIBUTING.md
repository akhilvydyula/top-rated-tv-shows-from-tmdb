# Contributing to TMDB Top-Rated TV Shows Dashboard

Thank you for helping improve **TMDB Top-Rated TV Shows Dashboard**! This project is part of the
...
```bash
git clone https://github.com/akhilvydyula/top-rated-tv-shows-from-tmdb.git
cd top-rated-tv-shows-from-tmdb
python -m venv .venv
...
- [GitHub Discussions](https://github.com/akhilvydyula/top-rated-tv-shows-from-tmdb/discussions) for Q&A
